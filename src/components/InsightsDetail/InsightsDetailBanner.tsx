...
const InsightsDetailBanner = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`w-full ${styles.caseStudyBannerHeight}  relative md:mt-[110px] mt-[75px]  bg-case-study-overlay transition-colors duration-300 z-0 flex justify-between`}>
        <div className="flex flex-col items-start content-start w-[40vw]">
          ...
          <h6 className={`${styles.caseStudySubtitle} ml-[7.2vw] mt-[1vh]`}>
