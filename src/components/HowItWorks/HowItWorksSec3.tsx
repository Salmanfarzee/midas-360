  ...
  return (
    <section className={` pt-1 ${styles.HowItWorksSec3}`}>
      ...
      <div className="px-[6.9vw] py-5 mt-12">
        <h2 className="  pb-3">midas360 Key Modules</h2>
        <p className="py-2">
      ...
      <div className=" px-[6.9vw] my-3">
        <h6 className="pb-4">Middleware Data Integration</h6>
        <p>
